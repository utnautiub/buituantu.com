...
export const PROJECTS: Project[] = [
  ...
  // `,
  //     logo: "/assets/images/project-logos/react-wheel-picker.svg",
  //     isExpanded: true,
  //   },
  //   {
  //     id: "chanhdaidotcom",
  ...
  //     logo: "/assets/images/project-logos/chanhdaidotcom.svg",
  //   },
  //   {
  //     id: "quaricdotcom",
  //     title: "quaric.com",
  ...
  //       "NGINX",
  //     ],
  //     logo: "/assets/images/project-logos/quaricdotcom.svg",
  //   },
  //   {
  //     id: "zadark",
  //     title: "ZaDark",
  ...
  //     logo: "/assets/images/project-logos/zadark.svg",
  //   },
  //   {
  //     id: "qabox",
  //     title: "QABox",
  ...
  //     logo: "/assets/images/project-logos/unlimitedstudy.webp",
  //   },
  //   {
  //     id: "dmessage",
  //     title: "DMessage",
